 ...
 * @author 繁星
 */
public class TreeArticleHolder extends BaseHolderRV<TreeArticleBean.DataBean.DatasBean> {
    ...
    public TreeArticleHolder(Context context, ViewGroup parent, BaseAdapterRV adapter, int itemType) {
    ...
    @Override
    protected void onRefreshView(TreeArticleBean.DataBean.DatasBean bean, int position) {
